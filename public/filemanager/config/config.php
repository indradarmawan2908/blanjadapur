...
error_reporting(0);
$nm_folder = $_SESSION["toko_folder"];
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => '/img/produk/'.$nm_folder.'/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../img/produk/'.$nm_folder.'/',
    ...
    |
    */
    'thumbs_base_path' => '../img/produk/'.$nm_folder.'/thumbs/',
    ...
    |
    */
    'thumbs_upload_dir' => '/img/produk/'.$nm_folder.'/thumbs/',
    ...
    */
    ...
    //*********************
    'ext_blacklist'							  => ['exe','bat','doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff','mov', 'mpeg', 'm4v', 'mp4', 'avi', 'mpg', 'wma', 'flv', 'webm','mp3', 'mpga', 'm4a', 'ac3', 'aiff', 'mid', 'ogg', 'wav','zip', 'rar', 'gz', 'tar', 'iso', 'dmg','php','js',''],
