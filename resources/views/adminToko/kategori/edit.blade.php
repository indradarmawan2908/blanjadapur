...
<div class="container mt-3 mb-3">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<form method="POST" action="{{ route('kategori.update',$kategori->id_ktg_produk) }}" enctype="multipart/form-data">
						@csrf
						@method('PUT')
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="nama">Nama Kategori</label>
								<input class="form-control" type="text" name="nama" id="nama" value="{{ $kategori->nm_ktg_produk }}" required>
							</div>
							<div class="form-group col-md-6">
