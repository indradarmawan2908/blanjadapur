...
<div class="container pt-3 pb-5">
    ...
    <div class="chatbox">
        ...
        <span class="tip tip-left"></span>
            <span><img src="/img/smile.png"> Ini isi kategori {{$kategori->nm_ktg_produk}} kak, silahkan dipilih.. <i class="far fa-hand-point-down"></i></span>
        </div>
    </div>
</div>
...
<div class="container">
	...
	@empty
		<div class="col">
			Belum ada item / produk di kategori ini.
		</div>
	@endforelse
	</div>
	<div class="row">
